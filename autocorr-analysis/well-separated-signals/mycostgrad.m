function [f, G] = mycostgrad(z, params)
    ...
    g_x = -2*w1*(ay1 - ay1_est)*rho*coeff ;
    g_rho = -2*w1*(ay1 - ay1_est)*ax1_est ;
    ...
    g_rho = g_rho - 2*w2*sum(diff_ay2 .* ax2_est) ;
    ...
    for l2 = 1:nbin
        for l1 = 1:l2
            g_rho = g_rho - 2*w3*diff_ay3(l1, l2)*ax3_est(l1, l2) ;
        end
    end
